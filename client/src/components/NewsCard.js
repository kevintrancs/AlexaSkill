              ...
              <Card className={classes.card}>
                <div className={classes.details}>
                  ...
                  <div className={classes.controls}>
                    ...
                    <div>
                        {this.state.liked ? 
                        <ThumbUpIcon className = {classes.likeIcon} onClick = {this.likeButtonClicked}/> : 
                        <ThumbUpOutlinedIcon className = {classes.likeIcon} onClick={this.likeButtonClicked} />
                        }
                        {this.state.disliked ? 
                        <ThumbDownIcon className={classes.likeIcon} onClick={this.dislikeButtonClicked}/> :
                        <ThumbDownOutlinedIcon className = {classes.likeIcon} onClick={this.dislikeButtonClicked}/>
                        }
                        {this.state.favorited ? 
                        <StarIcon className={classes.likeIcon} onClick={this.favoriteButtonClicked} /> :
                        <StarBorderOutlinedIcon className={classes.likeIcon} onClick={this.favoriteButtonClicked}/>                      
                        }
                    </div>
                  </div>
                </div>
